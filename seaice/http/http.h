#ifndef __SEAICE_HTTP_H__
#define __SEAICE_HTTP_H__
...
public:
    ...
    void setVersion(uint8_t v) {m_versoin = v;}
    ...
    bool checkGetHeaderAs(const std::string& key, T& val) {
        return checkGetAs(m_headers, key, val);
    }
    ...
    bool checkGetParamAs(const std::string& key, T& val) {
        return checkGetAs(m_params, key, val);
    }
    ...
    bool checkGetCookieAs(const std::string& key, T& val) {
        return checkGetAs(m_cookies, key, val);
    }
